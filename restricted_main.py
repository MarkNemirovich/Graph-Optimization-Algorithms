...
from restricted_ACO import aco_algorithm
...
def main():
    ...
    if (str == 'ppa'):
        ...
        graphs = aco_algorithm(G, demand_data, effective_distance_func, EPSILON, get_subgraphs=True, min_capacity= min_capacity)
